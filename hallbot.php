...
$this->version_message = "Hall Hall IRC Bot 1.0";

$this->currentserver = NULL;
$this->db = NULL;
$this->server_restart = "Restarting";
$this->server_quit = "I am leaving the server";
$this->using_host = NULL;
$this->global_user = NULL;
$this->registered = NULL;

$this->voteban['#HallHall']['num'] = 0;
$this->votekick['#HallHall']['num'] = 0;
$this->roulett['#HallHall'] = 0;
...
$this->send("PRIVMSG ChanServ IDENTIFY #HallHall wh4ti5up");
...
if($this->data['ping2'] == 'KICK')
{
$this->onkick();
}
if(substr($this->data['message'], 0, 1) == "!"){
$maction = explode(" ", $this->data['message']);
if(count($maction) == 1)
{
$maction[1] = "";
...
break;
default:
if("irc.n00bstories.com" != $this->data['from'] AND "Hall_Hall_Chat_Bot" != $this->data['from'] AND "Hall_Hall_Chat_Port" != $this->data['from'] AND "ownage.n00bstories.com" != $this->data['from']  AND "Global" != $this->data['from'] AND "NickServ" != $this->data['from'] AND "HostServ" != $this->data['from'] AND "ChanServ" != $this->data['from'] AND "home.n00bstories.com" != $this->data['from'])
{
...
$bot['botnick'] = "Hall_Hall_Chat_Bot";
